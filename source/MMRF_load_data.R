...
newMD <- file.path(dataPath, "metadata_032525/per_cell_metadata/032525_per_cell_md.rds") # "/opt/pmedseq-data/wcpilch/Projects/MMRF-ImmuneAtlas-Annotation/data//per_cell_md.rds"
...
cluster_naming <- read.csv(file.path(dataPath, "custom_MD/annotations_plotting_info_010824.csv"), header = T)
...
merged[["umap.sub"]] <- readRDS(file.path(dataPath, "metadata/validation_subumap_dimreduc.rds"))
newMD <- readRDS(newMD)
